...
const DoctorsCard = ({
  ...
  const handlePress = () => {
    router.push({ pathname: "/[doctor]", params: { doctor: name } });
  };

  return (
    <TouchableOpacity
      onPress={handlePress}
      className="h-[200px] w-[190px] bg-[#f3fffd] rounded-3xl flex flex-col justify-between p-3 items-center m-2"
    >
      ...
      <View className="w-full flex flex-row px-2 justify-between items-center  ">
        ...
        <Text className="text-gray-500 " style={{ fontFamily: "Pop" }}>
